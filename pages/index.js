...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className=' scroll-smooth  h-screen w-screen relative ' style={{ backgroundImage: "url('https://images.unsplash.com/photo-1640964828933-eb242cc56681?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1557&q=80')" }}>
        {/* <Image
